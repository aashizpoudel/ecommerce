...
<html lang="en">
    <head>
        ...
        <meta name=description content="An ecommerce site made for OpaLine Technology" />
        <meta name="keywords" content="shopping, ecommerce, store, electronics, electronics store, Shubham Dhakal, Aashiz Poudel," />
        
        <link rel="shortcut icon" href="{!! asset('/src/public/images/slider/fav-icon.png') !!}" />

        <title>OPA-Commerce</title>
